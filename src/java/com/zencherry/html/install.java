...
public class install extends HttpServlet {
	...
	Statement stmt=null;
        ...
        try{
            ...
            conn= DriverManager.getConnection("jdbc:postgresql://"+configUrl, configUser, configPass);
            stmt = conn.createStatement();
            stmt.executeUpdate("DROP TABLE IF EXISTS zcms CASCADE;");
            stmt.executeUpdate("CREATE TABLE zcms (id serial PRIMARY KEY, label character varying(50) NOT NULL, content text);");
